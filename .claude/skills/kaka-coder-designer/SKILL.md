...
> 平台规范单源；本仓由 init 复制至 `.claude/skills/kaka-coder-designer/`。域协作见 [coordination.md](references/coordination.md)。
...
| 复制到业务仓 | `kaka-utils-project-init` → `copy-init-skills.ps1` |
